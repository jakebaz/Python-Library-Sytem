...
class UserList(Users): #Inherit from UserList class
    ...
    def count_users(self):
        ...
        print('There are currently', count, 'users in your database')
        return count           
...
def system_test():
    ...
    user2 = Users('elliewantcookie', 'Ellie', 'Victoria', 5, 'Grey St', 'NE1 5AH', 'ellie@gmail.com', '23/08/1995')
    user3 = Users('johnnyboy22', 'John', 'Witherham', 25, 'Hammersmith Lane', 'DH14BY', 'johnnyw22@yahoo.co.uk', '07/02/1987')
    user4 = Users('TigerBoy88', 'Mike', 'Tyson', 13, 'Beverly Hills', '90035', 'miketyson@hotmail.com', '30/06/1966')
    user5 = Users('jakeyboii', 'Jake', 'Manson', 12, 'Grey St', 'NE1 6BR', 'jakeymanson@googlemail.co.uk', '23/11/1993')
